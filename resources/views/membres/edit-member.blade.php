...
<div class="form-group col">
  ...
  <div class="form-group col">
    ...
    <div class="form-group col">
        ...
        <input type="text" id="lieuNaissance" name="lieuNaissance" class="form-control" value="{{ old('lieuNaissance', $personne->lieuNaissance) }}">
    </div>
</div>
<br> 
<div class="row">
<div class="form-group col">
    ...
    <select id="gender" name="gender" class="form-select" onchange="toggleEpouseDe()">
        ...
        <option value="1" {{ old('gender', $personne->gender) == "1" ? 'selected' : '' }}>Homme</option>
        <option value="0" {{ old('gender', $personne->gender) == "0" ? 'selected' : '' }}>Femme</option>
    </select>
...
<div class="form-group col">
    ...
    <input type="number"  class="form-control" id="phone02" name="phone02"  value="{{ old('numeroTlp2', $personne->numeroTlp2) }}">
        ...
        <div class="form-group {{ $errors->has('groupage') ? 'has-error' : '' }} ">
            ...
            <select id='groupage' name='groupage' class="form-select">
                ...
                @foreach ($listeGroupage as $key => $value)
                     <option {!! $value->id == $personne->idGroupage ? 'selected' : ''!!} value='{!! $value->id !!}'>{!! $value->type !!}</option>
                @endforeach
...
<div class="form-group">
    ...
    <select id="acces" name="acces" class="form-select">
        <option value="superviser" {{ old('acces', $sousPersonne->role) == 'superviser' ? 'selected' : '' }}>Superviser</option>
        <option value="autoriser" {{ old('acces', $sousPersonne->role) == 'autoriser' ? 'selected' : '' }}>Autoriser</option>
    </select>
</div>
...
<div class="form-group" id="accesadmin_field" style="display: none;">
    ...
    <select id="accesadmin" name="accesadmin" class="form-select">
        <option value="admin" {{ old('accesadmin', $sousPersonne->acces) == 'admin' ? 'selected' : '' }}>Admin</option>
        <option value="sousadmin" {{ old('accesadmin', $sousPersonne->acces) == 'sousadmin' ? 'selected' : '' }}>Sous-admin</option>
    </select>
</div>
...
<div class="form-group" id="fonction_field" style="display: none;">
    ...
    <select id="fonction" name="fonction" class="form-select">
        <option value="medecin" {{ old('fonction', $sousPersonne->fonction) == 'medecin' ? 'selected' : '' }}>Médecin</option>
        <option value="infirmier" {{ old('fonction', $sousPersonne->fonction) == 'infirmier' ? 'selected' : '' }}>Infirmier</option>
    </select>
</div>
