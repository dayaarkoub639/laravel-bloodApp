...
<div class="container-fluid">
    ...
    <form class="card-title fw-semibold mb-4" action="{{route('membres')}}">
        ...
        <a href="{{ url('membres/modifier/'.$personne->idUser) }}" class="btn btn-sm btn-primary"><i
                class="ti ti-pencil"></i> Modifier</a>
    </form>
    ...
    <div class="row fiche">
        <div class="col-8">
            ...
            <form class="row g-3 form2">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label observation">Observations
                        médicales</label>
        ...
        <div class="col-4">
            <div class="row d-flex flex-column groupage ms-5">
                ...
                <div class="col-sm-10 form3">
                    ...
                    <input type="text" class="form-control-plaintext py-0"
                        value='C {{ ($personne->cMaj==1) ? "+":"-" }}'>
                    <input type="text" class="form-control-plaintext py-0"
                        value='E {{ ($personne->EMaj==1) ? "+":"-" }}'>
                    <input type="text" class="form-control-plaintext py-0"
                        value='c {{ ($personne->cMin==1) ? "+":"-" }}'>
                    <input type="text" class="form-control-plaintext py-0"
                        value='e {{ ($personne->eMin==1) ? "+":"-" }}'>
                    <input type="text" class="form-control-plaintext py-0"
                        value='Kell {{($personne->kell==1) ? "+":"-" }}'>
                </div>
            </div>
        </div>
